...
public class UraniumEntity extends Entity implements Ownable{
    private static final TrackedData<Integer> FUSE = DataTracker.registerData(UraniumEntity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<BlockState> BLOCK_STATE = DataTracker.registerData(UraniumEntity.class, TrackedDataHandlerRegistry.BLOCK_STATE);
    ...
    public UraniumEntity(EntityType<? extends TntEntity> entityType, World world) {
        super(entityType, world);
        this.intersectionChecked = true;
    }

    public UraniumEntity(World world, double x, double y, double z, @Nullable LivingEntity igniter) {
    ...
    public void copyFrom(Entity original) {
        ...
        if (original instanceof UraniumEntity tntEntity) {
    ...
    public Entity teleportTo(TeleportTarget teleportTarget) {
        ...
        if (entity instanceof UraniumEntity tntEntity) {
